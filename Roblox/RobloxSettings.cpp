...
RobloxSettings::RobloxSettings()
    : m_baseDomain(L"www.gametest1.robloxlabs.com")
    , m_baseURL(L"http://www.gametest1.robloxlabs.com")
    , m_baseURLWWW(L"http://www.gametest1.robloxlabs.com")
    , m_baseSecureURL(L"https://www.gametest1.robloxlabs.com")
    , m_baseApiURL(L"https://api.gametest1.robloxlabs.com")
...
{
    return L"https://en.help.gametest1.robloxlabs.com/hc/en-us";
}
...
{
    return L"https://ephemeralcountersoapi.gametest1.robloxlabs.com/v1.1/Counters/Increment/?apiKey=" + apiKey + L"&counterName=" + counterName + L"&amount=" + amount;
}
