...
namespace
{
    ...
    public:
        ...
        void writeEntry(const FLog::Channel& channelId, const char* message)
        {
            ...
            if (channels.end() == it)
            {
                ...
                StandardOut::singleton()->printf(MESSAGE_ERROR, "Opening log file at %s", path.c_str());
    ...
    static void log(FLog::Channel channelId, const char* message)
    {
